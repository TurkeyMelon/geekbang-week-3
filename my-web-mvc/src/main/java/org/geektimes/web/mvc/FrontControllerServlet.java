...
import org.geektimes.web.mvc.util.JsonUtils;
...
//    private final Map<String, Controller> controllersMapping = new HashMap<>();
    ...
    public static final String COMPONENTS_FACTORY_MAP = "componentsFactoryMap";
    ...
    private void initComponentMap(ServletContext servletContext) {
        ...
        Map<Class<?>, Object> initializedComponentsMap = (Map<Class<?>, Object>) servletContext.getAttribute(COMPONENTS_FACTORY_MAP);
