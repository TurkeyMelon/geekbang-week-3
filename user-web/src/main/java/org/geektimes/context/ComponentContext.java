...
//    }
    ...
    private final Map<Class<?>, Object> classComponentsMap = new LinkedHashMap<>();
    ...
    public void init(ServletContext servletContext) throws RuntimeException {
        ...
        servletContext.setAttribute(FrontControllerServlet.COMPONENTS_FACTORY_MAP, classComponentsMap);
    }
    ...
    protected void initializeComponents() {
        componentsMap.values().forEach(component -> {
            ...
            classComponentsMap.put(componentClass, component);
